...
std::vector<double> observe_desk_left={0.3782760798931122, -1.807453457509176, -1.470379654561178, -1.1602729002581995, 1.560141682624817, 1.9563981294631958};
std::vector<double> observe_desk_right={-0.11585075059999639, -1.7541731039630335, -1.6129143873797815, -1.0659402052508753, 1.6896229982376099, 1.4781898260116577};
...
enum M_robot_state{s_home,s_place,s_grasp_up,s_grasp_down,
...
bool is_obj_pose_valid(geometry_msgs::Pose pose_)
{
    ...
    else if(((m_robot_state == s_observe_desk_left) || (m_robot_state == s_observe_desk_right)) && (m_agv_state == desk))
    {
